...
@section('content')
    ...
    <form action="{{route('action')}}" class="form-inline" method="GET">
        ...
        @if (isset($_GET['search']))
            <input name="search" id="search" value="{{$_GET['search']}}" inputmode="search" class="typeahead form-control mr-sm-2" type="text" placeholder="Rechercher..." aria-label="Search">
        @else
            <input name="search" id="search" inputmode="search" class="typeahead form-control mr-sm-2" type="text" placeholder="Rechercher..." aria-label="Search">
        @endif
                                                    ...
                                                    <form action="{{ route('pokemon.edit', $pk->id) }}" method="GET">
                                                        <button class="btn btn-info w-100 m-auto" type="submit">Éditer
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                fill="orange" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <div class="w-100 my-2 ">
                                                    <form action="{{ route('pokemon.destroy', $pk->id) }}" method="POST">
                                                        ...
                                                        <button class="btn btn-info w-100 m-auto" type="submit">Supprimer
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                fill="#CF0000" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                                                <path
