                        ...
                        <div class="form-row">
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" name="hp" class="form-control" id="inputHp" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
                                    <label for="inputAttack">Attaque</label>
                                    <input type="number" name="attack" class="form-control" id="inputAttack" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
                                    <label for="inputDefense">Défence</label>
                                    <input type="number" name="defense" class="form-control" id="inputDefense" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
                                    <label for="inputSpecialAttack">Attaque spé</label>
                                    <input type="number" name="special_attack" class="form-control" id="inputSpecialAttack" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
                                    <label for="inputSpecialDefense">Défence spé</label>
                                    <input type="number" name="special_defense" class="form-control" id="inputSpecialDefense" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
                                    <label for="inputSpeed">Vitesse</label>
                                    <input type="number" name="speed" class="form-control" id="inputSpeed" min="1" max="255">
                                </div>
                                <div class="form-group col-6">
