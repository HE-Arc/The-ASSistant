...
return [
    ...
    */
    ...
    "accepted_if" => "Le :attribute doit être accepté si :other est :value.",
    ...
    "confirmed" => "La confirmation de :attribute de correspond pas.",
    ...
    "email" => "Le :attribute doit être une addresse valide.",
    "ends_with" =>
    ...
    "gte" => [
        ...
        "numeric" => "Le :attribute doit être plus grand ou egal a :value.",
        "string" =>
    ...
    "lte" => [
        ...
        "numeric" => "Le :attribute doit être plus petit ou egal a :value.",
        "string" =>
    ...
    "min" => [
        ...
        "numeric" => "Le :attribute ne doit pas être plus petit que :max.",
    ...
    "password" => [
        ...
        "mixed" =>
            "Le :attribute doit contenir au moins une majuscule et une minuscule.",
    ...
    "present" => "Le :attribute doit être present.",
